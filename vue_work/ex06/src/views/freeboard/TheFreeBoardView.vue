  ...
  <div>
    ...
    <div class="p-5">
      <div class="border border-b-slate-400 rounded p-3">
        <h1 class="font-bold">제목 <span class="font-normal">{{ title }}</span></h1>
        <hr class="my-5 ">
        <h1 class="font-bold">내용</h1>
      ...
      <div class="flex justify-between mt-5">
        <button class="px-4 py-2 bg-blue-500 text-white font-semibold 
                ...
                focus:outline-none focus:ring-2 focus:ring-blue-300" @click="pageMove(idx)">수정</button>
        <button class="px-4 py-2 bg-blue-500 text-white font-semibold 
                rounded-lg shadow-md hover:bg-blue-600 
                focus:outline-none focus:ring-2 focus:ring-blue-300" @click="doDelete(idx)">삭제</button>
      </div>
    </div>
  </div>
</template>
